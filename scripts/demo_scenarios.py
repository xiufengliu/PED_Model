...
def create_visualizations(results, output_dir="data/output/demo_social_building"):
    ...
    # Get the base directory (BASELINE)
    ...
    create_self_consumption_viz(results, viz_path, output_dir)
...
def create_self_consumption_viz(results, viz_path, output_dir=None):
    ...
    # If output_dir is not provided, use the parent directory of viz_path
    if output_dir is None:
        output_dir = os.path.dirname(viz_path)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(viz_path, 'monthly_self_consumption.png'))
    print(f"Monthly self-consumption visualization saved to {os.path.join(viz_path, 'monthly_self_consumption.png')}")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(viz_path, 'energy_sources_pie.png'))
    print(f"Energy sources pie chart saved to {os.path.join(viz_path, 'energy_sources_pie.png')}")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(viz_path, 'monthly_electricity.png'))
    print(f"Monthly electricity visualization saved to {os.path.join(viz_path, 'monthly_electricity.png')}")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(viz_path, 'monthly_heat.png'))
    print(f"Monthly heat visualization saved to {os.path.join(viz_path, 'monthly_heat.png')}")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(viz_path, 'monthly_electricity_prices.png'))
    print(f"Monthly electricity prices visualization saved to {os.path.join(viz_path, 'monthly_electricity_prices.png')}")
    ...
    if 'grid_import_emissions' in results and 'heat_emissions' in results:
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(viz_path, 'co2_emissions_pie.png'))
        print(f"CO2 emissions pie chart saved to {os.path.join(viz_path, 'co2_emissions_pie.png')}")
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(viz_path, 'monthly_co2_emissions.png'))
        print(f"Monthly CO2 emissions visualization saved to {os.path.join(viz_path, 'monthly_co2_emissions.png')}")
