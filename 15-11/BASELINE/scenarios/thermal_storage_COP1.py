def create_network(config_file, params_file, data_path):
    """
    Scenario PV + Battery + Thermal Storage 
    ...
    _temp_df = pd.read_csv(weather_path, index_col=0, parse_dates=True)
...
# (Opzione semplice alternativa, se preferisci)
# a, b = 2.5, 0.08
# COP_ts = (a + b * T_amb_C).clip(lower=1.8, upper=6.0)
