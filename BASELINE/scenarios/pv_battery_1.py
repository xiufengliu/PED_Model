...
def create_network(config_file, params_file, data_path):
    ...
    battery_params = params["pv_battery_1"]["battery"]
    ...
    # Evita arbitraggio: prezzi non negativi
    grid_price_series = grid_price_series.clip(lower=0.0)
    ...
    batt_cfg = params.get("pv_battery_1", {}).get("battery", {})
